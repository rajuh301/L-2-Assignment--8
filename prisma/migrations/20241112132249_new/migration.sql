/*
  ...
  - You are about to drop the `bookReturn` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "bookReturn" DROP CONSTRAINT "bookReturn_bookId_fkey";

-- DropForeignKey
ALTER TABLE "bookReturn" DROP CONSTRAINT "bookReturn_memberId_fkey";
...
-- AlterTable
ALTER TABLE "BorrowRecord" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
